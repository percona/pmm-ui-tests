...
docker exec -u 0 mongors3 /bin/bash -c "bash ./pmm-qa/pmm-tests/pmm2-client-setup.sh --pmm_server_ip 127.0.0.1 --client_version 2.34.0 --admin_password admin --use_metrics_mode no"
