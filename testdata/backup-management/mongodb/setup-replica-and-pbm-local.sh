...
# Install PBM 1.8.1
docker exec -u 0 mongors1 /bin/bash -c "percona-release enable pbm release && yum -y install https://repo.percona.com/pbm/yum/release/8/RPMS/x86_64/percona-backup-mongodb-1.8.1-1.el8.x86_64.rpm"
docker exec -u 0 mongors2 /bin/bash -c "percona-release enable pbm release && yum -y install https://repo.percona.com/pbm/yum/release/8/RPMS/x86_64/percona-backup-mongodb-1.8.1-1.el8.x86_64.rpm"
docker exec -u 0 mongors3 /bin/bash -c "percona-release enable pbm release && yum -y install https://repo.percona.com/pbm/yum/release/8/RPMS/x86_64/percona-backup-mongodb-1.8.1-1.el8.x86_64.rpm"
...
docker exec -u 0 -it pmm-client /bin/bash -c "percona-release enable pbm release && yum -y install https://repo.percona.com/pbm/yum/release/8/RPMS/x86_64/percona-backup-mongodb-1.8.1-1.el8.x86_64.rpm"
