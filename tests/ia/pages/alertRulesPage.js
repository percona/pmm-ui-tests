...
module.exports = {
  ...
  buttons: {
    ...
    goToFolderButton: (folderID) => locate('[aria-label="go to folder"]').withAttr({ 'href': `/graph/dashboards/f/${folderID}` }),
    managePermissionsButton: (folderID)  => locate('[aria-label="manage permissions"]').withAttr({ 'href': `/graph/dashboards/f/${folderID}/permissions` }),
