...
module.exports = {
  ...
  pathToPmmQaRepo: process.env.PATH_TO_PMM_QA || '/srv/pmm-qa',
  pathToFramework: `${this.pathToPmmQaRepo}/pmm-tests/pmm-framework.sh`,
  pathToPMMTests: `${this.pathToPmmQaRepo}/pmm-tests/`,
  sideMenu: {
