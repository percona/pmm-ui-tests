  ...
  async addRDS(serviceName, connection = {}) {
    ...
    const body = {
      rds: {
        ...
        address: address || remoteInstancesHelper.remote_instance.aws.aws_rds_8_0.address,
        ...
        service_name: serviceName,
        username: username || remoteInstancesHelper.remote_instance.aws.aws_rds_8_0.username,
        password: password || remoteInstancesHelper.remote_instance.aws.aws_rds_8_0.password,
        az: 'us-east-2a',
        cluster: cluster || remoteInstancesHelper.remote_instance.aws.aws_rds_8_0.clusterName,
        engine: DISCOVER_RDS.MYSQL,
        instance_id: serviceName,
        isRDS: true,
        pmm_agent_id: 'pmm-server',
        port: port || remoteInstancesHelper.remote_instance.aws.aws_rds_8_0.port,
        qan_mysql_perfschema: true,
        rds_exporter: true,
        region: 'us-east-2',
