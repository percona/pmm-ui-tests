  ...
  async verifyAgentLogLevel(agentType, dbDetails, logLevel) {
    ...
    switch (agentType) {
      case 'mongodb':
        ...
        I.assertEqual(log_level, expectedLogLevel, `Was expecting Mongo Exporter for service ${dbDetails.service_name} added again via inventory command and log level to have ${expectedLogLevel || 'warn'} set. The actual log level was: ${log_level}`);
        break;
      case 'node':
        ...
        assert.ok(log_level === expectedLogLevel, `Was expecting Node Exporter for service ${dbDetails.service_name} added again via inventory command and log level to have ${expectedLogLevel || 'warn'} set. The actual log level was: ${log_level}`);
        break;
      case 'mongodb_profiler':
        ...
        assert.ok(log_level === expectedLogLevel, `Was expecting MongoDB QAN Profile for service ${dbDetails.service_name} added again via inventory command and log level to have ${expectedLogLevel || 'warn'} set. The actual log level was: ${log_level}`);
        break;
      case 'postgresql':
        ...
        assert.ok(log_level === expectedLogLevel, `Was expecting Postgresql Exporter for service ${dbDetails.service_name} added again via inventory command and log level to have ${expectedLogLevel || 'warn'} set. The actual log level was: ${log_level}`);
      ...
      case 'pgstatmonitor':
        ...
        assert.ok(log_level === expectedLogLevel, `Was expecting PGSTAT_MONITOR QAN for service ${dbDetails.service_name} added again via inventory command and log level to have ${expectedLogLevel || 'warn'} set. The actual log level was: ${log_level}`);
        await I.verifyCommand(`docker exec ${dbDetails.container_name} pmm-admin inventory remove agent ${agent_id}`);
        break;
      case 'pgstatements':
        ...
        assert.ok(log_level === expectedLogLevel, `Was expecting PGSTATSTATEMENT QAN for service ${dbDetails.service_name} added again via inventory command and log level to have ${expectedLogLevel || 'warn'} set. The actual log level was: ${log_level}`);
        await I.verifyCommand(`docker exec ${dbDetails.container_name} pmm-admin inventory remove agent ${agent_id}`);
        break;
      case 'mysql':
      ...
      case 'qan-slowlog':
        ...
        assert.ok(log_level === expectedLogLevel, `Was expecting Slowlog QAN for service ${dbDetails.service_name} added again via inventory command and log level to have ${expectedLogLevel || 'warn'} set. The actual log level was: ${log_level}`);
        await I.verifyCommand(`docker exec ${dbDetails.container_name} pmm-admin inventory remove agent ${agent_id}`);
        break;
      case 'qan-perfschema':
        ...
        assert.ok(log_level === expectedLogLevel, `Was expecting PerfSchema QAN for service ${dbDetails.service_name} added again via inventory command and log level to have ${expectedLogLevel || 'warn'} set. The actual log level was: ${log_level}`);
        await I.verifyCommand(`docker exec ${dbDetails.container_name} pmm-admin inventory remove agent ${agent_id}`);
        break;
      default:
    }
