...
module.exports = {
  ...
  mySql: new LeftMenu('MySQL', '/graph/d/mysql-instance-overview/mysql-instances-overview',
    {
  ...
  mongoDb: new LeftMenu('MongoDB', '/graph/d/mongodb-instance-overview/mongodb-instances-overview',
    {
      ...
      highAvailability: new SubMenu(mo, 'High availability', '#',
        {
  ...
  postgreSql: new LeftMenu('PostgreSQL', '/graph/d/postgresql-instance-overview/postgresql-instances-overview',
    {
