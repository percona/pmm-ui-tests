  ...
  async upgradePMM(version, containerName, skipUpgradeLogs = false) {
    ...
    if (version > 11) {
      if (this.isAmiUpgrade) {
        ...
        I.waitForText(locators.successUpgradeMessage, 7200, locators.successUpgradeMsgSelector);
      }
      ...
      I.waitForText(locators.successUpgradeMessage, 3600, locators.successUpgradeMsgSelector);
