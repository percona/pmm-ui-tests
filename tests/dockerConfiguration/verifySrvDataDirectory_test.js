...
const runContainerWithoutDataContainer = async (I) => {
  ...
  await I.verifyCommand('chown -R pmm:pmm $HOME/srvNoData/ || true');
...
const runContainerWithPasswordVariable = async (I) => {
  ...
  await I.verifyCommand('chown -R pmm:pmm $HOME/srvPassword/');
...
const runContainerWithPasswordVariableUpgrade = async (I) => {
  ...
  await I.verifyCommand('chown -R pmm:pmm $HOME/srvPasswordUpgrade/');
