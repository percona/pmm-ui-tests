...
Data(data).Scenario(
  ...
  async ({
    ...
    I.say(await I.verifyCommand(`docker logs ${current.containerName}`));
    I.say(await I.verifyCommand(`docker-compose exec ${current.containerName} cat /srv/logs/pmm-managed.log`));
